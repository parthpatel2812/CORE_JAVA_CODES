...
public class AJ_Comparator {
    ...
    public static void main(String[] args) {
            ...
            AJ_Employee e6 = new AJ_Employee(103, "Xarth");
            ...
            switch (input) {
                case 1:
                    Collections.sort(list, new Comparator<AJ_Employee>() {
                        @Override
                        public int compare(AJ_Employee o1, AJ_Employee o2) {
